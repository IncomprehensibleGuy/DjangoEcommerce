...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('mainapp', '0017_auto_20201122_2323'),
    ]
    ...
    operations = [
        migrations.AlterField(
            model_name='order',
            name='delivery_time',
            field=models.TimeField(default=datetime.time(12, 0), verbose_name='Время доставки'),
        ),
        migrations.AlterField(
            model_name='order',
            name='payment_method',
            field=models.CharField(choices=[('card_online', 'Картой онлайн'), ('cash', 'Наличныйми при получении')], default='card_online', max_length=255, verbose_name='Способ оплаты'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('card_online', 'Картой онлайн'), ('cash', 'Наличныйми при получении')], default='card_online', max_length=255, verbose_name='Способ оплаты')),
                ...
                ('fff', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='mainapp.order')),
            ],
        ),
    ]
